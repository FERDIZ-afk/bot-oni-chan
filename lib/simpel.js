...
exports.modulewa = (conn, m, store) => {
	...
	if (m.message) {
		...
		if (m.quoted) {
			...
			m.quoted.mentionedJid = m.quoted.contextInfo ? m.quoted.contextInfo.mentionedJid : m.quoted.contextInfo ? m.quoted.contextInfo.mentionedJid : [] || m.msg.contextInfo ? m.msg.contextInfo.mentionedJid : []
